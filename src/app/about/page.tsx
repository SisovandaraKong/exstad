...
const IconRocket = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2c0 4-4 6-10 10 4 0 6 4 10 4s6-6 6-10-6-4-6-4z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M12 2l4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const IconShield = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2l7 4v6c0 5-3.6 9.7-7 10-3.4-.3-7-5-7-10V6l7-4z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const IconLightbulb = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9 18h6M10 22h4M12 2a6 6 0 00-4 10c0 2 1 3 1 3h6s1-1 1-3a6 6 0 00-4-10z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export default function AboutPage() {
  ...
  <div className="flex-1 space-y-6">
    ...
    <div className="flex justify-center">
          ...
          <div className="container mx-auto flex flex-col md:flex-row items-center gap-10 bg-white rounded-2xl shadow-md p-6">
            <div className="flex-1 ">
              ...
              <div className="font-size-d1"> 
                <p>
                  exSTAD connects students, alumni, and
                  institutions, offering a central hub for 
                  scholarships, programs, and updates.
                </p>
              </div>
            </div>
            <div className="">
            ...
            <Card className="p-10 rounded-2xl shadow-lg max-w-3xl mx-auto">
              ...
              <div className="flex-1">
                <p className="text-gray-700 text-lg leading-relaxed">
                  To enhance access to scholarships, programs, and opportunities for all students.
                </p>
              </div>
            </div>
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-6">
              ...
              <Card className="p-6 rounded-xl shadow-sm text-center bg-[#F5F5F7]">
                <div className="flex justify-center text-yellow-500 mb-3">
                  <Image src="/aboutUs/vector 4.svg" 
                    alt="icon" 
                    width={30}
                    height={30}
                    className="" 
              ...
              <Card className="p-6 rounded-xl shadow-sm text-center bg-[#F5F5F7]">
                <div className="flex justify-center text-yellow-500 mb-3">
                  <Image src="/aboutUs/vector 3.svg" 
                    alt="icon" 
                    width={30}
                    height={30}
                    className="" 
      ...
      {/* Mentors */}
      <section id="mentors" className="bg-cover bg-center py-12 px-4" style={{ backgroundImage: "url('/aboutUs/pngwing.png')" }}>
      ...
      <div key={name} className="rounded-2xl group">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="relative">
            ...
            <div className={`absolute -bottom-6 left-1/2 -translate-x-1/2 w-50 h-25 
                         rounded-t-full z-0 rotate-180
                         transition-all duration-500 ease-in-out
                         ${index === 0 ? "bg-[#2049D5] group-hover:bg-red-500" : "bg-red-500 group-hover:bg-[#2049D5]"} 
  ...
  {/* Team carousel simplified */}
    <section id="team" className="relative mt-16 px-4 py-12 bg-gradient-to-br from-fuchsia-50 to-indigo-100">
    ...
    />
      <div className="container mx-auto px-4">
        ...
        <section className="container mx-auto mt-16 px-4 py-12">
          <div className="text-center mb-10">
            <h2 className="text-xl font-bold mb-5">How we treat our work</h2>
            <p>
              At exSTAD, every project we take on is handled with care, precision, and a
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-lg shadow-[#ddc2ff] hover:shadow-[0_0_25px_5px_rgba(48,158,196,0.7)] transition">
            ...
            <p className="mt-2 text-sm text-foreground/70">
              – We hold ourselves accountable to strong moral and ethical principles.
            </p>
          </div>
      ...
      <section className="container mx-auto py-12">
        ...
        <div className="md:ml-12">
          ...
          <h4 className="text-sm font-semibold text-primary mb-2">CONTACTS Us</h4>
          <ul className="space-y-2 text-sm text-[#253C95]">
            ...
            >
              ...
              <a href="mailto:info.istad@gmail.com" className="hover:underline">
...
const team = [
  { name: "Srun OudomSambath", role: "exSTAD Leader", badge: ".Back-End",image: "/aboutUs/1Photo.png"},
  { name: "Kong Sisovandara", role: "exSTAD Team", badge: ".Back-End", image: "/aboutUs/2Photo.png" },
  { name: "Kung Sovanda", role: "exSTAD Team", badge: ".Back-End", image: "/aboutUs/3Photo.png" },
  { name: "Chhun Meyling", role: "exSTAD Team", badge: ".Front-End", image: "/aboutUs/4Photo.png" },
  { name: "Leng Narak", role: "exSTAD Team", badge: ".Front-End", image: "/aboutUs/5Photo.png" },
  { name: "Tong Bora", role: "exSTAD Team", badge: ".Back-End", image: "/aboutUs/6Photo.png" },
  { name: "Phum Sreynoch", role: "exSTAD Team", badge: ".Back-End", image: "/aboutUs/members/Photo.png" },
  { name: "Teng Menghouy", role: "exSTAD Team", badge: ".Back-End", image: "/aboutUs/8Photo.png" },
];