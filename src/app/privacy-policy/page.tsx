		...
		<div className='min-h-screen bg-background flex justify-center p-6'>
			<div className='bg-card shadow-lg rounded-2xl max-w-6xl w-full p-8'>
				...
				<p className='text-color leading-relaxed mb-6'>
					This webpage (together with the webpages and documents referred to in
					it) sets out the terms and conditions (the Terms) on which you may use
					our websites whether as a guest or a registered user. Please read
					these Terms carefully before you start to use our sites. By using our
					sites, you accept these Terms and agree to abide by them. If you do
					not agree to, or breach these Terms, please refrain from using our
					sites.
				</p>

				{/* Accessing Section */}
				<h2 className='text-xl font-semibold tracking-[0.2rem] mb-4'>
					ACCESSING TO OUR SITE
				</h2>
				<ul className='list-disc pl-6 text-color space-y-2 mb-6'>
					<li>
				...
				<ul className='list-disc pl-6 text-color space-y-2 mb-6'>
					<li>
						Do not insult, abuse, harass, stalk, threaten or otherwise infringe
					...
					<li>
						Do not communicate spam, advertise or sell services such as digital
						downloads, eBooks or phishing links.
					</li>
					<li>
						You may not copy, distribute and indulge in plagiarism with website
						content or user submitted content.
					</li>
				</ul>
				...
				<ul className='list-disc pl-6 text-color space-y-2 mb-6'>
					<li>
						You may not mirror or frame the home page or any other pages of this
						Site on any other web site or web page.
					</li>
					<li>
						Do not link to ISTAD pages and subpages with spam links/anchor text
						which could provide false impression. This may create
					...
					<li>
						Do not link to pages which provide pornographic content and violate
						human rights.
					</li>
					<li>
						Do not communicate spam, advertise or sell services such as digital
				...
				<ul className='list-disc pl-6 text-color space-y-2 mb-6'>
					<li>
						<span className='font-semibold text-lg'>Registration: </span>we open
						for online registration. The registration will be closed one week
						before the course starts. The registration of specific courses can
						be closed earlier due to the number of students registered.
					</li>
					<li>
				...
				<ul className='list-disc pl-6 text-color space-y-2 mb-6'>
					<li>
						<span className='font-semibold text-lg'>Certificate: </span>The
						certificate will be issued for students who successfully complete
						all assessments of each course including Homework, attendance, mini
