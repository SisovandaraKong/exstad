...
export function WhyChooseEXSTAD_Card() {
	return (
		<div className='relative'>
			...
			{/* Image Section */}
			<div className='absolut h-500px] w-full flex justify-center gap-6 px-4 sm:px-8 md:px-16 lg:px-32 mb-12'>
				<Image
			...
			{/* Card L */}
			<div className='absolute w-full py-3 flex flex-col gap-y-2 px-4 sm:px-8 md:px-16 lg:px-32'>
				<FeatureCard
			...
			{/* Card R */}
			<div className='absolute w-full py-3 flex flex-col items-end gap-y-2 px-4 sm:px-8 md:px-16 lg:px-32'>
				<FeatureCard
					icon={<LuLaptopMinimalCheck className='text-2xl' />}
					title='Quality Education'
					description=''
