...
const iconFor = (title: string) => {
  ...
  if (key.includes("mail") || key.includes("email")) return <CgMail className="text-red-500" />;
      ...
      <div className="md:col-span-6 lg:col-span-4">
        <div className="sticky top-6 md:top-20 self-start">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6 w-full box-border">
            ...
            {/* About */}
            <div className="pt-4">
              <h3 className="font-d2 font-semibold mb-2 dark:text-white text-lg">About</h3>
            ...
            {/* Social */}
            <div className="pt-4">
              <h3 className="font-d2 font-semibold mb-2 dark:text-white text-lg">Social Media</h3>
