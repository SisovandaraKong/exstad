...
import { RadixSheetDemo as StudentButtonSetting } from "@/components/button/StudentButtonSetting";
import {
        ...
        <div className="sticky top-4 md:top-20 self-start">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-32 h-32 sm:w-45 sm:h-45 mb-4">
                <Image
            ...
            {/* About */}
            <div className="pt-4">
              <h3 className="font-d2 font-semibold text-color mb-2 dark:text-white text-sm sm:text-base">
                About
              </h3>
            ...
            {/* Social */}
            <div className="pt-4">
              <h3 className="font-semibold font-d2 text-color mb-2 dark:text-white text-sm sm:text-base">
                Social Media
              </h3>
              <div className="space-y-2 font-d3 dark:text-white text-sm sm:text-base">
