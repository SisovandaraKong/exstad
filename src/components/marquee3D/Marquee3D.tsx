...
const reviews = [
	{
		...
		icon: "https://www.vhv.rs/dpng/d/6-61727_college-student-icon-png-transparent-png.png",
	},
	{
		name: "Real Projects",
		username: "",
		body: "All ISTAD students must complete real-world projects to graduate.",
		icon: "https://cdn-icons-png.flaticon.com/512/3158/3158428.png",
	},
	{
		name: "Job Offer",
		username: "",
		body: "At ISTAD, 92% of students secure internships before graduation.",
		icon: "https://cdn-icons-png.flaticon.com/512/196/196754.png",
	},
];
