...
const ShortCourseCardActive: React.FC<programType> = ({
  ...
  openingprogram
          ...
          <Link href={`/explore-course/${id}`}><Image unoptimized height={500} width={500} src={openingprogram?.[0]?.shortcourseimage || "/placeholder.jpg"} alt={title} className="h-fit rounded-[20px] object-cover"/></Link>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h1 className="text-primary text-[30px] font-bold hover:text-primary-hover">  {title}
                  </h1>
                  </Link>
