...
const ShortCourseCard: React.FC<programType> = ({
  ...
  return (
    <div className=" rounded-[20px] p-4 md:p-10 lg:p-[70px] hover:shadow-lg transition-shadow duration-300" style={{ background: bg }} >
  {/* Header section */}
<div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-4 md:gap-6">
  ...
  <Image unoptimized width={120}  height={120}  src={image} alt={title} className="w-[120px] h-[120px] md:w-[192px] md:h-[192px] object-cover rounded-lg mx-auto md:mx-0"  />
</div>
