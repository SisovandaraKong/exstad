...
import type { HandleConfig ,WorkNodeData } from "../../types/roadmap"
    ...
    return (
      <>
        <Handle
          ...
          className={`${baseClassName} ${colorClass("source")} ${hoverClassName} ${positionOffsets[position]} hidden`}
        ...
        <Handle
          ...
          className={`${baseClassName} ${colorClass("target")} ${hoverClassName} ${positionOffsets[position]} hidden`}
