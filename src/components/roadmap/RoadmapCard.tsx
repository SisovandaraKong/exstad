    ...
    >
      ...
      <div className="relative flex items-center gap-4 p-6">
        ...
        <div className="relative shrink-0">
          <div
            className={cn(
              "flex size-14 items-center justify-center rounded-lg shadow-lg shadow-primary/20 transition-all duration-500",
          ...
          >
            <Image
              ...
              height={32}
              className={cn(
                "size-8 text-primary transition-all duration-500",
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-1.5">
          ...
          {label && (
            <Badge
              variant="secondary"
              className={cn(
                "w-fit rounded-full border-0 bg-secondary/60 px-2.5 py-0.5 text-[11px] font-medium tracking-wide backdrop-blur-sm transition-all duration-300",
