...
const Card2 = ({ person }: { person: (typeof data.scholars2)[number] }) => (
  <div className="rounded-xl p-[2px] bg-gradient-to-r from-blue-500 to-pink-500 shadow-md transition">
    <div className="rounded-xl bg-white dark:bg-slate-800 p-10 text-center">
      ...
      <p className="text-lg text-slate-500 dark:text-slate-400">{person.title}</p>
...
export default function ScholarsPage() {
  ...
  return (
    <>
     ...
     {/* === SECTION 1: Infinite Scroll with Static Gradient Background === */}
<section className="relative isolate overflow-hidden min-h-screen bg-gradient-to-b from-pink-200 via-purple-200 to-indigo-200">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 -translate-y-10">
